...
export default function DirectMessage() {
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hey! I'm looking to cut down on my carbon emissions on our next trip.",
      isUser: true,
    },
    {
      id: 2,
      text: "Great! We can all take turns driving and combine trips when possible. I can help you set up a shared calendar and track your carpool mileage. Does that sound good?",
      isUser: false,
    },
    {
      id: 3,
      text: "Yes, that sounds perfect! Let's set up the calendar and get started.",
      isUser: true,
    },
  ]);
    ...
    <Container>
      ...
      <MainContent>
        ...
        <MessageInput>
          ...
          />
          <Smile size={20} style={{marginRight: "10px"}}/>
